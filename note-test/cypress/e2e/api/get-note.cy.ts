...
describe("Feature: API GET note", () => {
  ...
  context("Given the API is available", () => {
    ...
    context("When they make a GET request without passing the note ID And there are saved notes", () => {
      let id = "";
    ...
    context("When they make a GET request without passing the note But there are no saved notes", () => {
    ...
    context("When they make a GET request passing the ID of an existing note", () => {
      let id = "";
      ...
      it("Then the API should return status code 200 and the data of the note", () => {
